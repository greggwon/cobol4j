...
This document provides detailed examples of every COBOL feature mapped to
the cobol4j Java API — data layout, arithmetic, control flow, file I/O,
string operations, SQL, CICS, and more.

For a quick overview, see [README.md](README.md).
For runnable demonstrations, see [EXAMPLES.md](EXAMPLES.md).
